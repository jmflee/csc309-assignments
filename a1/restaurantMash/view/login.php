<?php
// So I don't have to deal with unset $_REQUEST['username'] when refilling the form
		...
		<main>
			...
			<form method="post">
				...
				<table>
					...
					<tr><th><label for="username">Username</label></th><td><input type="text" name="username" value="<?php echo($_REQUEST['username']); ?>" /></td></tr>
			...
			<a href="index.php?page=register">New Member</a>
		</main>
		<footer>
		</footer>
	</body>
